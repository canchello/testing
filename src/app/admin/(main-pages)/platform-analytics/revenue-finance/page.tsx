  ...
  return (
    <div className='space-y-4'>
      <div className='bg-white p-4 rounded-lg grid grid-cols-1 xs:grid-cols-3 gap-4'>
        ...
        <StatisticsCard title='Total Users' number='840' change='8.70' />
        <StatisticsCard title='Active Users' number='840' change='8.70' />
        <StatisticsCard title='New Users' number='840' change='8.70' />
        {/* <StatisticsCard title='Net Profit' number='12%' change='5.70' /> */}
      </div>
      <div className='grid grid-cols-1 xs:grid-cols-3 gap-4'>
        <div className='bg-white p-4 rounded-lg'>
          <h1 className='text-lg font-bold'>User Growth Trends</h1>
        ...
        <div className='bg-white p-4 rounded-lg'>
          <h1 className='text-lg font-bold'>User Preferences</h1>
        ...
        <div className='bg-white p-4 rounded-lg'>
          <h1 className='text-lg font-bold'>Active User Breakdown</h1>
