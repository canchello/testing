...
const LoginForm = () => {
  ...
  return (
    <div className='md:w-1/2 md:px-8 md:max-h-screen overflow-auto z-20'>
      <div className='lg:p-8 flex flex-col justify-center items-center gap-2 lg:gap-4 text-black text-center bg-white rounded-lg'>
